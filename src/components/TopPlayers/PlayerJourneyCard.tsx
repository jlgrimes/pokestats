...
export const PlayerJourneyCard = (props: PlayerJourneyCardProps) => {
  return (
    <>
      <Text fontWeight={'semibold'}>{reallyShortenTournamentName(props.journeyPoint.tournament)}</Text>
      ...
      <DeckInfoDisplay player={props.journeyPoint.standing} tournament={props.journeyPoint.tournament} enableEdits={false} />
    </>
  )
}